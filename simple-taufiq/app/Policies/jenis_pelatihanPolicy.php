...
class jenis_pelatihanPolicy
{
     ...
     */
    public function view(User $user, jenis_pelatihan $jenisPelatihan): bool
    {
     ...
     */
    public function update(User $user, jenis_pelatihan $jenisPelatihan): bool
    {
     ...
     */
    public function delete(User $user, jenis_pelatihan $jenisPelatihan): bool
    {
     ...
     */
    public function forceDelete(User $user, jenis_pelatihan $jenisPelatihan): bool
    {
     ...
     */
    public function restore(User $user, jenis_pelatihan $jenisPelatihan): bool
    {
     ...
     */
    public function replicate(User $user, jenis_pelatihan $jenisPelatihan): bool
    {
